		...
		try {
			...
			if (isHydrating$1) if (this.forwarded && !fallback) {
				...
				if (contentValid) {
					...
					const anchor = this.anchor = markHydrationAnchor(!!(process.env.NODE_ENV !== "production") ? /* @__PURE__ */ createComment((_this$anchorLabel = this.anchorLabel) !== null && _this$anchorLabel !== void 0 ? _this$anchorLabel : "") : /* @__PURE__ */ createTextNode());
					const slotEnd = getCurrentSlotEndAnchor();
